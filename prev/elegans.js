...
define('utils/TrackballControls',[],function(){
    ...
    var TrackballControls = function ( object, domElement ) {
        ...
        this.rotateSpeed = 0.5; // 1.0 is default
        this.zoomSpeed = 1.2;
        this.panSpeed = 0.3;
    ...
    this.dynamicDampingFactor = 0.2; // set from 0.4 to 0.2 for demo
            ...
            return function () {
                ...
                if ( angle ) {
                    ...
                    if ( _this.staticMoving ) {
                        ...
                        //if(_state == STATE.NONE) // removed for demonstration of the original trackball
                        //    damping *= 0.25;
...
var i = 0; document.frameSkip =2;
        this.animate = function(){
            window.requestAnimationFrame(world.animate);
            var now = Date.now();
            if(!(i++%document.frameSkip)) {
			...
			console.log(world.invalidateUntil < now ? 'no-inv' : 'inv');
        };
